  ...
  return (
    <header className="bg-panel border-b border-panel-border px-2 py-2">
      <div className="min-w-0 flex items-center justify-between">
        <div className="flex flex-row justify-center items-center min-w-0">
          <h2 className="text-xl font-heading font-bold uppercase tracking-wider text-text truncate min-w-0">
            ArmyAssist.xyz
          </h2>
          <Changelog />
        </div>
