  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-4 left-4 bg-blue-600 text-white rounded p-2 font-bold hover:bg-blue-700 shadow-xl z-10 opacity-60 hover:opacity-100 transition-opacity duration-300"
